  ...
  return (
    <>
      ...
      <TechSection>
        ...
        <Card img="/sass-logo.png" title="SCSS/SASS & BootStrap" text="I've learned TS through OneBitCode course and it became my favourite language. I use TS in almost every project." url="#"/> 
